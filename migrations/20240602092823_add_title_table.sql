...
CREATE TABLE title(
	...
	CONSTRAINT title_allowed_cols_type_d_e_f
	CHECK (
	type IN ('d', 'e', 'f') OR
	(number_of_episodes, number_of_seasons) IS NULL)
);
